...
const RoomManagementPage = () => {
  ...
  const currentUser = roomInfo.users.find((u) => u.userId === user?.id);
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white">
                    {roomInfo.users.find((u) => u.userId === roomInfo.createdBy)
                      ?.username || "Unknown"}
                  </p>
                </div>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="secondary">
                    {roomInfo.users.length} member
                    {roomInfo.users.length !== 1 ? "s" : ""}
                  </Badge>
                </div>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {roomInfo.users.map((member) => (
                    <div
                      key={member.socketId}
